        ...
        <View className="h-full w-full bg-white rounded-t-[30px] p-4 ">
          ...
          <View className='pt-8'>
            ...
            <View className='flex flex-row items-center bg-[#F3F6FD] p-3 py-1  mt-2 rounded-2xl'>
              ...
              <TextInput textContentType='telephoneNumber' placeholder='Enter Your Phone Number' className='pl-2 w-fit text-sm text-black' placeholderTextColor={'#9DB2CE'}/>
            </View>
          </View>
          <Pressable className='mt-8 flex justify-center w-full flex-row' onPress={() => {navigation.navigate('OtpScreen')}}>
